...
const Mobile = () => {
  return (
    <>
      <div className="bg-[#EAE2D2] py-20 px-4 md:mt-10">
        <div className="container grid grid-cols-1 gap-8 md:grid-cols-2 md:items-center ">
          <article>
            <img
      ...
      <div className='bg-[#502215] p-4 text-white text-center text-sm mb-20'>
        TM & Copyright 2023 Burger King Company LLC. All Rights Reserved. | Do
